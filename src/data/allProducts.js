const allProducts = [
    // 20 adet Bileklik
    { id: 1, title: "Altın Bileklik", category: "bileklik", price: 180, description: "Modern tasarım altın bileklik", image: "/src/assets/images/bileklik-1.jpg" },
    { id: 2, title: "Altın Bileklik", category: "bileklik", price: 170, description: "Şık altın bileklik", image: "/src/assets/images/bileklik-2.jpg" },
    { id: 3, title: "Altın Bileklik", category: "bileklik", price: 190, description: "Minimalist tasarım altın bileklik", image: "/src/assets/images/bileklik-3.jpg" },
    { id: 4, title: "Altın Zincir Bileklik", category: "bileklik", price: 200, description: "Şık charm detaylı altın bileklik", image: "/src/assets/images/bileklik-4.jpg" },
    { id: 5, title: "Altın Zincir Bileklik", category: "bileklik", price: 185, description: "Zarif altın zincir bileklik tasarımı", image: "/src/assets/images/bileklik-5.jpg" },
    ...
    { id: 7, title: "Altın Zincir Bileklik", category: "bileklik", price: 220, description: "Altın zincir charm detaylı bileklik", image: "/src/assets/images/bileklik-7.jpg" },
    { id: 8, title: "Altın Bileklik", category: "bileklik", price: 230, description: "Şık ve zarif altın bileklik", image: "/src/assets/images/bileklik-8.jpg" },
    { id: 10, title: "İnce Altın Bileklik", category: "bileklik", price: 195, description: "Şık tasarımlı altın bileklik", image: "/src/assets/images/bileklik-10.jpg" },
    { id: 11, title: "Altın Bileklik", category: "bileklik", price: 215, description: "Zarif altın burgu detaylı bileklik", image: "/src/assets/images/bileklik-11.jpg" },
    { id: 12, title: "Altın Bileklik", category: "bileklik", price: 225, description: "Kalın Zincirli Altın bileklik tasarımı", image: "/src/assets/images/bileklik-12.jpg" },
    { id: 13, title: "Kalın Zincir Altın Bileklik", category: "bileklik", price: 235, description: "Kalın zincir detaylı altın bileklik", image: "/src/assets/images/bileklik-13.jpg" },
    { id: 14, title: "İkili Altın Bileklik", category: "bileklik", price: 250, description: "Modern tasarımlı ikili altın bileklik", image: "/src/assets/images/bileklik-14.jpg" },
    { id: 15, title: "Altın Tasarım Bileklik", category: "bileklik", price: 255, description: "Zarif altın tasarım", image: "/src/assets/images/bileklik-15.jpg" },
    { id: 16, title: "Gümüş Bileklik", category: "bileklik", price: 265, description: "Şık gümüş kelepçe bileklik", image: "/src/assets/images/bileklik-16.jpg" },
    { id: 17, title: "Gümüş Zincir Bileklik", category: "bileklik", price: 275, description: "Gümüş zincir detaylı bileklik", image: "/src/assets/images/bileklik-17.jpg" },
    { id: 18, title: "Gümüş Bileklik", category: "bileklik", price: 285, description: "Modern zincir gümüş bileklik", image: "/src/assets/images/bileklik-18.jpg" },
    { id: 19, title: "Gümüş Bileklik", category: "bileklik", price: 290, description: "Şık zincirli gümüş bileklik tasarımı", image: "/src/assets/images/bileklik-19.jpg" },
    { id: 20, title: "Gümüş Bileklik", category: "bileklik", price: 300, description: "Zarif ince tasarımlı kelepçe gümüş bileklik", image: "/src/assets/images/bileklik-20.jpg" },
