...
import "../assets/Categories.css"; // CSS dosyasını ekledik

import firstBannerImage from "../assets/images/tum-takilar-1.jpg"; // İlk banner için görsel
...
const banners = [
  { type: "grid", image: firstBannerImage }, // İlk banner artık bir fotoğrafa sahip
...
function Categories() {
  ...
  // Eğer category parametresi varsa, ürünleri filtrele
